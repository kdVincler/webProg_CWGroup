...
export default defineComponent({
  ...
  methods: {
    async handleRegister() {
        if (this.name === "" || this.email === "" || this.dob === "" || this.pw == "" || this.cpw === "") {
        ...
        try {
            ...
            if (response.ok) {
                ...
                this.name, this.email, this.dob, this.pw, this.cpw = ""
...
<template>
    <div class="flex flex-col justify-center items-center h-screen w-screen gap-2">
        ...
        <label class="input input-bordered flex items-center gap-2">
            ...
            <input type="date" class="grow w-[197px]" v-model="dob"/>
        </label>
        <label class="input input-bordered flex items-center gap-2">
            <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <input type="password" class="grow" placeholder="Password" v-model="pw"/>
        </label>
        <label class="input input-bordered flex items-center gap-2">
            <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <input type="password" class="grow" placeholder="Confirm password" v-model="cpw"/>
        </label>
        <button class="btn btn-md btn-neutral" @click="handleRegister">Register</button>
    </div>
</template>
